...
const generateWordPuzzlePrompt = ai.definePrompt({
  ...
  prompt: `You are a creative game master. Generate {{{count}}} word puzzles based on the theme of {{{theme}}}.
  ...
  3. A short, one-sentence "Did you know?" style explanation of what the word means in the context of sustainability. For example: "Carpooling is when multiple people travel together in one car to reduce traffic and emissions."
  `,
});
